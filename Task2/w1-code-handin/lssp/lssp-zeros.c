...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    struct futhark_i32_1d *read_value_5190;
    int64_t read_shape_5191[1];
    int32_t *read_arr_5192 = NULL;
    
    errno = 0;
    if (read_array(&i32_info, (void **) &read_arr_5192, read_shape_5191, 1) !=
        0)
    ...
    if (perform_warmup) {
        ...
        assert((read_value_5190 = futhark_new_i32_1d(ctx, read_arr_5192,
                                                     read_shape_5191[0])) != 0);
        ...
        r = futhark_entry_main(ctx, &result_5193, read_value_5190);
        if (r != 0)
            futhark_panic(1, "%s", futhark_context_get_error(ctx));
        if (futhark_context_sync(ctx) != 0)
            futhark_panic(1, "%s", futhark_context_get_error(ctx));
        ...
        assert(futhark_free_i32_1d(ctx, read_value_5190) == 0);
        ;
    }
    time_runs = 1;
    // Proper run.
    ...
    write_scalar(stdout, binary_output, &i32_info, &result_5193);
    printf("\n");
    ;
}
...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_5189,
                       struct memblock xs_mem_5183, int32_t implz2080U_5124);
                       ...
                       struct memblock xs_mem_5183, int32_t implz2080U_5124)
{
    ...
    redout_5179 = 0;
    redout_5181 = 0;
    for (int32_t i_5182 = 0; i_5182 < implz2080U_5124; i_5182++) {
        int32_t x_5172 = ((int32_t *) xs_mem_5183.mem)[sext_i32_i64(i_5182)];
        bool res_5174 = x_5172 == 0;
        int32_t xmatch_5175 = btoi_bool_i32(res_5174);
        bool cond_5145 = redout_5181 == 0;
        bool x_5147 = cond_5145 && res_5174;
        bool res_5152 = redout_5179 == 0;
        bool x_5153 = !x_5147;
        bool y_5154 = res_5152 && x_5153;
        bool connect_5155 = x_5147 || y_5154;
        int32_t newlss_5156;
        
        if (connect_5155) {
            int32_t res_5157 = smax32(xmatch_5175, redout_5176);
            int32_t max_arg_5158 = add32(xmatch_5175, redout_5178);
            int32_t res_5159 = smax32(res_5157, max_arg_5158);
            
            newlss_5156 = res_5159;
        } else {
            int32_t res_5160 = smax32(xmatch_5175, redout_5176);
            
            newlss_5156 = res_5160;
        }
        
        bool x_5166 = connect_5155 && res_5174;
        int32_t newlcs_5167;
        
        if (x_5166) {
            int32_t res_5168 = add32(1, redout_5178);
            
            newlcs_5167 = res_5168;
        } else {
            newlcs_5167 = xmatch_5175;
        }
        
        int32_t newtl_5169 = add32(1, redout_5179);
        int32_t redout_tmp_5185 = newlss_5156;
        int32_t redout_tmp_5186 = newlcs_5167;
        int32_t redout_tmp_5187 = newtl_5169;
        int32_t redout_tmp_5188 = x_5172;
        
        redout_5176 = redout_tmp_5185;
        redout_5178 = redout_tmp_5186;
        redout_5179 = redout_tmp_5187;
        redout_5181 = redout_tmp_5188;
    }
    res_5127 = redout_5176;
    res_5129 = redout_5178;
    res_5130 = redout_5179;
    res_5132 = redout_5181;
    scalar_out_5184 = res_5127;
    *out_scalar_out_5189 = scalar_out_5184;
...
int futhark_entry_main(struct futhark_context *ctx, int32_t *out0, const
                       struct futhark_i32_1d *in0)
{
    struct memblock xs_mem_5183;
    
    xs_mem_5183.references = NULL;
    
    int32_t implz2080U_5124;
    int32_t scalar_out_5184;
    
    lock_lock(&ctx->lock);
    xs_mem_5183 = in0->mem;
    implz2080U_5124 = in0->shape[0];
    
    int ret = futrts_main(ctx, &scalar_out_5184, xs_mem_5183, implz2080U_5124);
    
    if (ret == 0) {
        *out0 = scalar_out_5184;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
