...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    if (perform_warmup) {
        ...
        r = futhark_entry_main(ctx, &result_5139, read_value_5136);
        if (r != 0)
            futhark_panic(1, "%s", futhark_context_get_error(ctx));
        if (futhark_context_sync(ctx) != 0)
            futhark_panic(1, "%s", futhark_context_get_error(ctx));
    ...
    write_scalar(stdout, binary_output, &i32_info, &result_5139);
    printf("\n");
    ;
}
...
static int futrts_main(struct futhark_context *ctx,
                       int32_t *out_scalar_out_5135,
                       struct memblock xs_mem_5129, int32_t implz2080U_5070);
                       ...
                       struct memblock xs_mem_5129, int32_t implz2080U_5070)
{
    ...
    redout_5125 = 0;
    redout_5127 = 0;
    for (int32_t i_5128 = 0; i_5128 < implz2080U_5070; i_5128++) {
        int32_t x_5120 = ((int32_t *) xs_mem_5129.mem)[sext_i32_i64(i_5128)];
        bool res_5091 = redout_5127 == x_5120;
        bool res_5096 = redout_5125 == 0;
        bool x_5097 = !res_5091;
        bool y_5098 = res_5096 && x_5097;
        bool connect_5099 = res_5091 || y_5098;
        int32_t newlss_5100;
        
        if (connect_5099) {
            int32_t res_5101 = smax32(1, redout_5122);
            int32_t max_arg_5102 = add32(1, redout_5124);
            int32_t res_5103 = smax32(res_5101, max_arg_5102);
            
            newlss_5100 = res_5103;
        } else {
            int32_t res_5104 = smax32(1, redout_5122);
            
            newlss_5100 = res_5104;
        }
        
        int32_t newlcs_5111;
        
        if (connect_5099) {
            int32_t res_5112 = add32(1, redout_5124);
            
            newlcs_5111 = res_5112;
        } else {
            newlcs_5111 = 1;
        }
        
        int32_t newtl_5113 = add32(1, redout_5125);
        int32_t redout_tmp_5131 = newlss_5100;
        int32_t redout_tmp_5132 = newlcs_5111;
        int32_t redout_tmp_5133 = newtl_5113;
        int32_t redout_tmp_5134 = x_5120;
        
        redout_5122 = redout_tmp_5131;
        redout_5124 = redout_tmp_5132;
        redout_5125 = redout_tmp_5133;
        redout_5127 = redout_tmp_5134;
    }
    res_5073 = redout_5122;
    res_5075 = redout_5124;
    res_5076 = redout_5125;
    res_5078 = redout_5127;
    scalar_out_5130 = res_5073;
    *out_scalar_out_5135 = scalar_out_5130;
...
int futhark_entry_main(struct futhark_context *ctx, int32_t *out0, const
                       struct futhark_i32_1d *in0)
{
    struct memblock xs_mem_5129;
    
    xs_mem_5129.references = NULL;
    
    int32_t implz2080U_5070;
    int32_t scalar_out_5130;
    
    lock_lock(&ctx->lock);
    xs_mem_5129 = in0->mem;
    implz2080U_5070 = in0->shape[0];
    
    int ret = futrts_main(ctx, &scalar_out_5130, xs_mem_5129, implz2080U_5070);
    
    if (ret == 0) {
        *out0 = scalar_out_5130;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
